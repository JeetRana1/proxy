...
export const domainRules: DomainRule[] = [
  ...
  {
    patterns: [
      /clearskyline88\.online$/i,
      /crimsonstorm18\.pro$/i,
      /sunshinerays93\.live$/i,
      /clearbluesky72\.wiki$/i,
      /breezygale56\.online$/i,
      /sunburst93\.live$/i,
  ...
  {
    patterns: [/^pru\.ultracloud\.cc$/i],
    origin: "https://pru.ultracloud.cc",
    referer: "https://pru.ultracloud.cc/",
  },
  // Catch-all for weather-themed random CDN hostnames (must stay last)
  {
